...
Пример:
```
SHAPE "Администратор" 200 150 150 80 #FF4444 rectangle
SHAPE "HR-менеджер" 400 150 150 80 #32CD32
```
...
Пример:
```
STICKY "Важная заметка" 300 200 light_yellow
STICKY "Права доступа\n+ Чтение\n+ Запись" 400 300 light_pink
STICKY "Многострочный\nтекст\nс переносами" 500 400 light_blue
```
